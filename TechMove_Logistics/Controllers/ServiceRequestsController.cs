...
namespace TechMove_Logistics.Controllers
{
    ...
    public class ServiceRequestsController : Controller
    {
        ...
        {
            var request = await _httpClient.GetFromJsonAsync<ServiceRequestViewModel>($"api/servicerequests/{id}");
        ...
        {
            var rate = await _httpClient.GetFromJsonAsync<decimal>("api/servicerequests/rate");
            return Json(rate);
        }
    }
}
